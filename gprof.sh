...
gcc main.c var.o flow.o flow_grafica.o flow_strutture.o flow_game.o flow_app.o -o ./flow -Wall -pg --pedantic -lm
./flow
gprof flow gmon.out > profile-data.txt
mate-terminal -- /bin/sh -c 'nano profile-data.txt'
